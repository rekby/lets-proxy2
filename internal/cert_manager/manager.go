	...
	authDomainLoop:
		...
		challengeTypeLoop:
			for _, challengeType := range challengeTypes {
				...
				cleanup, err := m.fulfill(ctx, chal, domain.DomainName(z.Identifier.Value))
...
func supportsECDSA(hello *tls.ClientHelloInfo) bool {
	...
	for _, suite := range hello.CipherSuites {
		switch suite {
		case // tls.TLS_ECDHE_ECDSA_WITH_RC4_128_SHA,		// WEEK (0xc007)
//			tls.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA,	// WEEK (0xc009) ECDH secp521r1 (eq. 15360 bits RSA) FS 128
//			tls.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA,	// WEEK (0xc00a) ECDH secp521r1 (eq. 15360 bits RSA) FS 256
			tls.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256,	// OK   (0xc023)
			tls.TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,	// OK   (0xc02b) ECDH secp521r1 (eq. 15360 bits RSA) FS	128
			tls.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,	// OK   (0xc02c) ECDH secp521r1 (eq. 15360 bits RSA) FS	256
			tls.TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305:	// OK   (0xcca9) ECDH secp521r1 (eq. 15360 bits RSA) FS	256P
			return true
		}
	}
	return false
